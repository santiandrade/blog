...
window.SITE_POST_BODIES["hermes-agent"] = {
  introHtml: `<span data-l="es">Durante mucho tiempo usé la inteligencia artificial como usamos casi todos una herramienta nueva: abría una pestaña, hacía una pregunta, copiaba el resultado y seguía con mi vida. Era útil, pero cada conversación empezaba prácticamente desde cero. Yo no quería otro chat. Quería un asistente que entendiera mi contexto, pudiera hacer cosas y mejorase conmigo.</span><span data-l="en">For a long time I used artificial intelligence the way most of us use a new tool: I opened a tab, asked a question, copied the result and carried on with my life. It was useful, but every conversation started almost from scratch. I did not want another chat. I wanted an assistant that understood my context, could do things and improved alongside me.</span>`,
  bodyHtml: `
